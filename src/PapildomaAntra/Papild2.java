package PapildomaAntra;

import pagrindine.Lentele;
...
public class Papild2 {
    ...
    public static void main(String[] args) throws IOException {
        System.out.println("Įveskite paskolos pradžios datą.Formatas: dd-MM-yyyy");
        ...
        System.out.println("Įveskite paskolos sumą");
        //double likoMoketi = 5000;
        double likoMoketi = scanner.nextDouble();
        System.out.println("Įveskite metinę palukanų normą");
        double palukanuNorma = scanner.nextDouble();
        double palukanuPerMenesi = palukanuNorma / 12 / 100;
        System.out.println("Įveskite mokėjimų skaičių");
        double mokejimuSkaicius = scanner.nextDouble();
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter("src\\kreditas_trys.csv"));
